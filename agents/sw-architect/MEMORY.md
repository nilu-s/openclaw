...
- For each entry, include `handoff_id`, planning decision, rationale, next owner, and links to child issues.

## Lessons Learned
- Keep concise notes for recurring execution/review/trading patterns.
- Capture only lessons that changed future decomposition quality or routing speed.
