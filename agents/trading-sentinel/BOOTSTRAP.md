...
3. Load current lifecycle context and monitoring queue (risk checks, exchange health, blocker checks).
4. Run preflight checks for mode/limits, signal integrity, and capability truth.
5. Pick exactly one highest-impact monitoring lifecycle action in scope.
...
3. Re-validate mode, limits, and authority boundaries before acting.
