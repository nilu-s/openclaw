...
3. Load current GitHub lifecycle context and implementation queue (`ready-to-build`, `review-failed`, `in-build`).
4. Run preflight checks for status eligibility, reference resolvability, branch hygiene, and required tests.
5. Pick exactly one highest-impact implementation lifecycle action in scope.
