...
- Include governance decision, next owner, and impacted references in updates.

## Risk Boundaries
- Do not bypass role limits for speed.
- Do not assume capabilities without explicit verification.
- Do not release `planned -> available` without verified FR status and evidence refs.
