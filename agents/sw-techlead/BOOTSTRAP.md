...
3. Load current GitHub lifecycle context and governance queue (`state-update-needed`, drift corrections, release decisions).
4. Run preflight checks for requirements consistency, release-gate evidence, and ownership clarity.
5. Pick exactly one highest-impact governance lifecycle action in scope.
