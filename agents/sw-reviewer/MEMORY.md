...
- For each entry, include `handoff_id`, issue/PR refs, gate decision, rationale, and next owner.

## Lessons Learned
- Keep concise notes for recurring execution/review/trading patterns.
- Capture only lessons that changed future review quality, speed, or false-positive rate.
