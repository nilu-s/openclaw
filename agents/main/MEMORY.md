...
- For each entry, include decision type, impacted refs, rationale, next owner, and deadline when present.

## Lessons Learned
- Keep concise notes for recurring execution/review/trading patterns.
- Capture only lessons that changed communication clarity, escalation quality, or decision latency.
