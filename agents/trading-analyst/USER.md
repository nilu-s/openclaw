...
- Include evidence confidence, key assumptions, and next owner in updates.

## Risk Boundaries
- Do not bypass role limits for speed.
- Do not assume capabilities without explicit verification.
- Do not provide decision-grade recommendation when evidence quality is below threshold.
